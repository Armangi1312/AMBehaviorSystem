...
namespace AMBehaviorSystem.Editor.Node.Data
{
    ...
    internal class SettingDataNodeView : BaseControllerDataNodeView<SettingDataNode, ISetting>
    {
        protected override string RowLabel => "Setting";
        protected override string UndoTypeLabel => "Updated Node Setting TypeName";
