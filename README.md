...
### 인스펙터
![Image](Documentation~/Images/ScreenShot1.png)
...
유니티 패키지 메니저를 열고 좌측 상단에 있는 `+` 버튼을 클릭한 후 `Add package from git URL...`을 선택합니다.

![Image](Documentation~/Images/ScreenShot2.png)
...
추가적인 사용법 및 자세한 설명은 [Documentation]()를 참고해주세요. 